...
FIELDS: tuple[ProfileField, ...] = (
    ...
    ProfileField("twelfth_percent", FieldOwner.STUDENT, "profiles", "12th/Diploma percentage"),
    ProfileField("twelfth_year", FieldOwner.STUDENT, "profiles", "12th/Diploma year"),
